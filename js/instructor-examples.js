...
//   // ** Сздание стрелочной Callback функции и определение ее в переменную*/
//   const multipliesNumberByTwo = value => value * 2;

//   console.log(each([2, 3, 4, 5], multipliesNumberByTwo));
//   console.log(
...
//   console.log(each([1, 2, 3, 4], value => value * 2));
